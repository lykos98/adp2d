...
radius = 10
halo = False
use_asterism_bg_reject = False


fitsPath = "deblending_sim/simulated_image.fits"
#fitsPath = "/home/francesco/Downloads/mosaic_elgordo_cluster_nircam_f444w_30mas_20230718_drz.fits"

mask_path = "mask.npy.int32"
...
if use_asterism_bg_reject:
	...
	mask = np.fromfile("mask.npy.int32", dtype.int32).reshape((100,100))
